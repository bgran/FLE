...
# $Id: xmlrpclib.py,v 1.2 2002/02/16 13:41:45 granbo Exp $
#
...
# Modified to support Basic authentication using code from
...
class Server:
    ...
    def __init__(self, uri, login=None, password=None, transport=None):
        ...
        if transport is None:
            transport = Transport(login, password)
